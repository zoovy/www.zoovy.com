...
print "Content-Disposition: inline; filename=\"files.json\"\n";
print "X-Content-Type-Options: nosniff\n";
print "Access-Control-Allow-Origin: *\n";
print "Access-Control-Allow-Methods: OPTIONS, HEAD, GET, POST, PUT, DELETE\n";
print "Access-Control-Allow-Headers: X-File-Name, X-File-Type, X-File-Size\n";

if ($ENV{'REQUEST_METHOD'} eq 'OPTIONS') {
	}
elsif (($ENV{'REQUEST_METHOD'} eq 'HEAD') || ($ENV{'REQUEST_METHOD'} eq 'GET')) {
	}
